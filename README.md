...
<body>
    <header>
        <div class="logo">
            <img src="retro relish logo.png" alt="RETRO RESTAURANT Logo">
            <h1 style="font-family: 'Times New Roman', Times, serif;"> RETRO RELISH </h1>
        </div>
        <nav class="menu">
            <ul>
    ...
    <main>
        ...
        <footer>
            <div class="logo">
                <img src="retro relish logo.png" class="footer" alt="Retro Restaurant Logo">
            </div>
            ...
            <h3align="center" style="font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; font-style: italic; ">
                Developed and designed by ASHIKA TR</h3>
        </footer>
    </main>
</body>
</html>
...
<div class="logo">
    <top left>
    <img src="retro relish logo.png" width="50" height="50"alt="RETRO RESTAURANT LOGO">
</top left>
...
<body bgcolor="lavender">
    ...
    <div class="logo">
        <img src="restaurant.png"50" height="50" class="footer" alt="Retro Restaurant logo">
    </div>
...
<body>
    ...
    <div class="menu-container">
        ...
        <div class="menu-items">
            ...
            <div class="menu-item">
                <img src="prawn fry.png" alt="prawn">
                <div class="menu-details">
                    <h3>Prawn</h3>
                    <p class="price">₹150/-</p>
                </div>
            ...
            <div class="menu-item">
                <img src="Full meals.png" alt="Full meals">
                <div class="menu-details">
                    <h3>Full meals/h3>
                    <p class="price">₹200/-</p>
                </div>
            ...
            <div class="menu-item">
                <img src="veg nodles.png" alt="Veg noodles">
                <div class="menu-details">
                    <h3>Veg Noodles</h3>
                    <p class="price">₹250/-</p>
                </div>
            ...
            <div class="menu-item">
                <img src="kaju.png" alt="kaju katli">
                <div class="menu-details">
                    <h3>kaju katli</h3>
                    <p class="price">₹300/-</p>
                </div>
            ...
            <div class="menu-item">
                <img src="coco milkshake.png" alt="chocolate milkshake">
                <div class="menu-details">
            ...
            <div class="menu-item">
                <img src="strawberry.png" alt="strawberry milkshake">
                <div class="menu-details">
    ...
    <footer>
        ...
        <p align="center" class="copy">&copy; Copyright Retro Reslish</p>
...
<div class="logo">
<img src="retro relish logo.png" width="50" height="50" class="footer" alt=" REtro Restaurant Logo">
</div>
...
<!DOCTYPE html>
 ...
 <body>
    <header>
        <top left>
        <div class="logo">
            <img src="retro relish logo.png" width="100" height="100" alt="Retro Restaurant Logo">
    ...
    <main>
        <div class="container">
            ...
            <div class="team-section">
                <div class="team-member">
                    <img src="damu.png"alt="founder.jpg">
                    <h3>founder</h3>
                    
                </div>
                <div class="team-member">
                    <img src="but.png" alt="co-founder.jpg">
                    <h3>co-founder</h3>
                
                </div>
                <div class="team-member">
                    <img src="hari.png" alt="Hari nayak.jpg">
                    <h3>Hari nayak-Marketing director</h3>
                   
                </div>
                <div class="team-member">
                    <img src="ranveer.png" alt="Ranveer brar.jpg">
                    <h3>Ranveer brar-Manager</h3>

                </div>
                <div class="team-member">
                    <img src="saransh.png" alt="Saransh goila.jpg">
                    <h3>Saransh goila-Master Chef</h3>
            
                </div>
                <div class="team-member">
                    <img src="koushik.png" alt="Koushik S.jpg">
        ...
        <footer>
            <div class="logo">
                <img src="retro relish logo.png" width="50" height="50" class="footer" alt="Fusion feast Logo">
            </div>
            
                <palign="center" class="copy">&copy; Copyright Retro Relish</p>
...
footer {
    ...
    <footer>
        ...
        <p align="center" class="copy">&copy; Copyright Reto relish</p>
...
## OUTPUT:
![Screenshot 2025-05-05 122134](https://github.com/user-attachments/assets/bae00dcd-ba48-4e22-9734-be67d6c655f8)
![Screenshot 2025-05-05 122201](https://github.com/user-attachments/assets/44974465-7e79-4378-9e43-6bd32ea20da4)
![Screenshot 2025-05-05 122224](https://github.com/user-attachments/assets/44980e5a-4a59-40b1-9fc1-4149d91436a2)
![Screenshot 2025-05-05 122239](https://github.com/user-attachments/assets/d4b60046-d7b7-4550-87b9-5654065ebe32)
![Screenshot 2025-05-05 122256](https://github.com/user-attachments/assets/14a948e7-9677-4579-9d5b-d929de11d869)
![Screenshot 2025-05-05 122340](https://github.com/user-attachments/assets/4d3a94a9-9f77-47ef-9e55-3e9206d27146)
